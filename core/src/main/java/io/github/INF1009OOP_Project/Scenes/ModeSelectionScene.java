...
public class ModeSelectionScene extends Scene{
	...
	public ModeSelectionScene(SceneManager sceneManager, IOManager io) {
		...
		sub = new ModeCheckbox(10 + checkboxSize + 10,Gdx.graphics.getHeight()/2, checkboxSize,checkboxSize,"-", 40, font);
		mult = new ModeCheckbox(10 + (checkboxSize + 10)*2,Gdx.graphics.getHeight()/2, checkboxSize,checkboxSize,"x", 40, font);
		div = new ModeCheckbox(10 + (checkboxSize + 10)*3,Gdx.graphics.getHeight()/2, checkboxSize,checkboxSize,"÷", 40, font);
